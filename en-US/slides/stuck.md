...
|------------------|---------|
| **Browser Info** | Browser name and version (e.g., Chrome 126, Safari 18.1, Edge 126) |
| **System Info** | Computer: operating system and version (e.g., macOS 15.4, Windows 11 24H2); Mobile: system and version (e.g., iOS 18.4, Android 15, HarmonyOS 5.0) and phone model |
| **Screenshot** | Capture the full browser window or App interface showing the abnormal page |
| **Steps to Reproduce** | Briefly describe the steps to reproduce the issue |
