...
preview: true
preview_content: "Generate polished presentations from text or documents with Kimi's AI-powered Slides tool."
---
...
|------|----------|----------|
| Creation method | Manual layout, page-by-page design | One prompt generates a complete outline + content + design |
...
|------|-----------|
| **Work report** | Convert this quarterly sales data Word document into a 10-slide deck, business style, highlighting growth trends |
| **Industry research** | Generate a presentation analyzing the 2025 domestic NEV market, covering competitive landscape, technology roadmap, and policy context |
| **Course materials** | Create a 15-slide introductory training deck on RAG technology for non-technical product managers |
