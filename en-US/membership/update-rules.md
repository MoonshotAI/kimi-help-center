---
title: "Credit update & usage rules"
slug: "update-rules"
order: 3
...
Credits are consumed based on the number of tokens a task processes. Longer inputs and outputs use more tokens.

<Callout type="info">
**Rough guide for free-tier users**:
- Generating a simple slide deck ≈ 1–2% of your credits
- Running a deep research report ≈ 5–10%
- Writing a code snippet ≈ 0.5–2%
Higher-tier plans come with proportionally larger credit pools.
</Callout>

## Credit refresh rules
| Rule | Description |
|------|-------------|
| **Cycle** | Monthly and annual subscribers both receive credits on a **monthly** cycle |
...
1. **Cycle-based** — Credits refresh on your subscription anniversary date, not the calendar month
2. **No rollover** — Remaining credits reset to zero, then your full allotment is re-issued
3. **Example** — If you subscribed on December 1 at 3:00 PM, your credits refresh on January 1 at 3:00 PM

<Callout type="info">
**System errors**: If a task fails due to a system issue, use the 👎 button to report it and request a credit refund.
</Callout>
