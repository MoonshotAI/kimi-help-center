...
|-----------|-------------|---------|
| **Name & role** | Give it a name, job title, or character archetype | "Your name is Claw. You're my research assistant." |
| **Tone** | Shorter, more formal, more playful, or more cautious | "Be concise and formal" |
| **Structure** | Always open with a summary, always close with action items | "Start every reply with a one-sentence summary" |
...
| Category | Examples |
|----------|----------|
| **Information curation** | News digests, competitive analysis, meeting-notes templates |
| **Analysis** | Market trends, data interpretation, risk extraction |
| **Workflows** | End-to-end pipelines from requirements → breakdown → output → review |
...
**Template**:
> At **[time]**, do **[task]**, output as **[format]**, following **[constraints]**.
**Examples**:
