...
//Frames
![image](images/search/search-01.png)
//
...
//Frames
![image](images/search/search-03.png)
//
...
//Frames
![专业信源](images/search/search-05.png)
//
开启后，你可以在对话中直接引用专业数据库进行提问，Kimi 会自动从对应数据库中检索并返回结果。

//Frames
![专业数据库展示](images/search/search-06.gif)
//
...
//Frames
![image](images/search/search-04.jpg)
//
