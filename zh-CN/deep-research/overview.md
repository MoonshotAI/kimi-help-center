...
//Frames
![交付物](images/deep-research/overview-01.gif)
//

2. 一个可交互、可分享的动态可视化报告
//Frames
![image](images/deep-research/overview-02.png)
//
...
## 适用场景
//Frames
![image](images/deep-research/overview-03.png)
//
...
### 产品入口
//Frames
![网页版入口](images/deep-research/overview-04.png)
![App入口](images/deep-research/overview-05.png)
//
...
### 操作步骤
//Frames
![输入问题](images/deep-research/overview-06.png)
//
1. 输入研究问题并发送；
//Frames
![意图澄清](images/deep-research/overview-07.png)
//
2. 根据 Kimi 返回的澄清问题，确认或细化研究方向，也可点击「做个全面的研究」（Include everything）跳过；
3. 系统进入自动执行阶段，可实时查看检索关键词、推理过程及访问网址；
//Frames
![检索和执行过程](images/deep-research/overview-08.gif)
//
4. 研究完成后，获取深度报告与可视化报告两份成果：
//Frames
![报告成果](images/deep-research/overview-02.png)
//
