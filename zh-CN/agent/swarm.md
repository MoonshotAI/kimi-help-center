...
注意：目前，K2.5 Agent 集群还处于Beta（内测）阶段，仅Allegretto、Allegro会员可用。Agent 集群任务消耗的额度较高（约为普通 Agent 任务的数倍），具体取决于任务复杂度和子智能体数量。
...
2. Kimi K2.5技术报告 - "KIMI K2.5: VISUAL AGENTIC INTELLIGENCE" (arXiv:https://arxiv.org/pdf/2602.02276 )
