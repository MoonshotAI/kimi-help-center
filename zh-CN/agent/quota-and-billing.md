...
<SeoMeta
  ...
  pageUrl="https://www.kimi.com/help/agent/agent-quota-and-billing"
/>
# Agent 额度与计费

Agent 模式使用 Kimi 统一额度进行计费。所有会员功能（Agent、深度研究、PPT、文档、表格、Kimi Code、Kimi Claw 等）共享同一个额度池，额度按实际 token 消耗扣除。

## 计费方式

- **统一额度**：所有会员功能共享一个额度池，你可以自由分配使用
