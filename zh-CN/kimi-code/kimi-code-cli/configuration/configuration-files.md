  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi --config-file /path/to/config.toml",
    },
  ]}
/>
  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi --config '{\"default_model\": \"kimi-for-coding\", \"providers\": {...}, \"models\": {...}}'",
    },
  ]}
/>
  ...
  files={[
    {
      name: "config.toml",
      language: "toml",
      content: "[models.kimi-k2-thinking-turbo]\nprovider = \"moonshot-cn\"\nmodel = \"kimi-k2-thinking-turbo\"\nmax_context_size = 262144\ncapabilities = [\"thinking\", \"image_in\"]",
    },
  ]}
/>
