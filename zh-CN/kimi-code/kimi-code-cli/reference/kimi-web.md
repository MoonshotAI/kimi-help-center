  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi web --network --auth-token my-secret-token",
    },
  ]}
/>
  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi web --network --allowed-origins \"https://example.com,https://app.example.com\"",
    },
  ]}
/>
  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi web --network --public --auth-token my-secret-token",
    },
  ]}
/>
  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi web --network --restrict-sensitive-apis",
    },
  ]}
/>
  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi web --dangerously-omit-auth",
    },
  ]}
/>
  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi web --network --auth-token $(openssl rand -hex 32)",
    },
  ]}
/>
  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi web --reload --no-open",
    },
  ]}
/>
