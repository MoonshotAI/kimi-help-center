...
API 速率限制基于账户的**累计充值金额**进行分级，充值金额越高，可用的速率限制越高。具体分级标准和对应的 RPM（每分钟请求数）、TPM（每分钟 token 数）限制，请参考 [platform.kimi.com/](https://platform.kimi.com/) 控制台中的说明。
...
- **联系客服**：如有特殊需求，可联系平台客服或通过 [platform.kimi.com/](https://platform.kimi.com/) 联系销售团队，申请定制化的速率配额。
