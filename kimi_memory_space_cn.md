...
<img width="1494" height="672" alt="image" src="https://github.com/user-attachments/assets/3525f59f-c095-4018-8a72-c29d8ee32df0" />
...
“请你记得....”
".......，不要忘了"
<img width="1424" height="670" alt="image" src="https://github.com/user-attachments/assets/92a32bc3-ddc0-4007-807f-70a3b16b6998" />


### 更新记忆
可以在用户主页-设置-个性化-记忆空间，点击删除单条记忆
<img width="1182" height="858" alt="image" src="https://github.com/user-attachments/assets/f9583c62-e5ab-4cdd-beba-2839a6dd63a5" />

### 删除（忘记）记忆
可以在用户主页-设置-个性化-记忆空间，点击删除单条记忆
<img width="1160" height="698" alt="image" src="https://github.com/user-attachments/assets/d06faeb0-b6ed-44f6-8900-fef05aed5d85" />

### 查看记忆
直接问：
“你当前都记住了我什么？”
<img width="1280" height="1069" alt="image" src="https://github.com/user-attachments/assets/8c786497-26e0-4f03-9d42-43773a3cf067" />
...
- 最多可存储 **50 条**记忆
- 每条记忆内容上限为 **500 个字符**
  - 2026 年 4 月前创建的记忆可能超过此限制，这些记忆仍会保留
  - 如需编辑超过 500 字符的旧记忆，必须先删减至 500 字符以内
  - 若尝试保存超过 500 字符的内容，模型将收到"content too long"提示，用户端显示"记忆更新失败"
  - 如用户使用非中文界面，可建议改用中文存储，以在同等字符限制下容纳更多信息

- 每条记忆都有内部 ID 编号，但用户无法查看这些 ID，因此对话中提及记忆编号无助于定位特定记忆
